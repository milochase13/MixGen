...
def query_openai(prompt, num_songs, song_options, model="gpt-3.5-turbo"):
    # system_prompt = """You are a helpful assistant. Your job is to recommend songs for a music playlist given a list of song options. You will give your response as a python list in the following schema: [["song1", "artist1", "reason1"], ["song2", "artist2", "reason2"], ..., ["songn", "artistn", "reason3"]], where there are n songs and the "reason" field is a very brief explanation for the corresponding song choice. Do not include any text in your response other than the output in this schema."""
    system_prompt = """You are a helpful assistant. Your job is to recommend songs for a music playlist given a list of song options. You will give your response as a python list in the following schema: [["song1", "artist1"], ["song2", "artist2"], ..., ["songn", "artistn"]], where there are n songs. Do not include any text in your response other than the output in this schema."""
